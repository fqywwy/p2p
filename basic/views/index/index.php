...
<div class="banner">
  <div id="inner">
    <div class="hot-event">
      ...
      <div class="event-item" style="background-color:#c20000; background-image:url(/assets/home/upload/img4.jpg);"><a href="index.html" title="十七金融"></a></div>
      <div class="event-item" style="background-color:#c20000; background-image:url(/assets/home/upload/img4.jpg);"><a href="index.html" title="十七金融"></a></div>
      <div class="event-item" style="background-color:#c20000; background-image:url(/assets/home/upload/img4.jpg);"><a href="index.html" title="十七金融"></a></div>
      ...
      <div class="bd clearfix">
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(/assets/home/images/100.png) no-repeat center;">100%</div>
        ...
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(/assets/home/images/75.png) no-repeat center;">75%</div>
            <a href="invest-list.html" class="ico btn-Tender">投标</a>
            剩余金额 250,000元
          </div>
        </div>
        <div class="item">
          ...
          <div class="progress fl">
            <div class="ui-progressbar-mid" style="background:url(/assets/home/images/50.png) no-repeat center;">50%</div>
            <a href="invest-list.html" class="ico btn-Tender">投标</a>
            剩余金额 250,000元
          </div>
        </div>
  ...
  <div class="indexaside fr">
    ...
    <div class="mt10 bd bdr">
      ...
      <div class="reports mt10 clearfix">
        <dl class="clearfix">
          <dt class="img"><a href="reportshow.html"><img src="/assets/home/upload/img5.jpg"></a></dt>
          <dd><a href="newshow.html">互联网金融应该充当毛细血管的角色-上海法治声音</a></dd>
        </dl>
        <dl class="clearfix">
          <dt class="img"><a href="reportshow.html"><img src="/assets/home/upload/img6.jpg"></a></dt>
          <dd><a href="newshow.html">互联网金融应该充当毛细血管的角色-上海法治声音</a></dd>
        </dl>
      </div>
    ...
    <!--ad-->
    <div class="ad img mt10"><a href="#" class="btn-reg"><img src="/assets/home/upload/img7.jpg"></a></div>
